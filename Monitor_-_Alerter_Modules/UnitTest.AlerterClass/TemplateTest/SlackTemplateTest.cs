...
{
    [TestClass]
    public class SlackTemplateTest
    {
        private static ErrorDataObject ErrorData = new ErrorDataObject()
        {
            Message = "This is a unit test for Slack JSON templates.",
        ...
        {
            Recipient = new string[] { $"{Environment.GetEnvironmentVariable("WebhookSlack")}" },
            Subject = "UnitTest",
        ...
        {
            string FilledTemplate = TemplateManager.GetFilledTemplate(@".\Templates\SlackTemplate.json", alertParam);
        ...
        {
            var TemplateContent = File.ReadAllText(@".\Templates\SlackTemplate.json");
            string FilledTemplate = TemplateManager.GetFilledTemplate(TemplateContent, alertParam);
            string ExampleTemplate = File.ReadAllText(@".\ExampleTemplates\SlackTemplate.json");
