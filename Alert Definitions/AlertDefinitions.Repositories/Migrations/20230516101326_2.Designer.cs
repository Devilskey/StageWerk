...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AlertDefinitions.Repositories.Models.AlertDefinition", b =>
                {
                    ...
                    b.Property<int?>("ExceptionTypeRegexId")
                        .HasColumnType("int");

                    b.Property<int?>("LogLevelExpressionId")
                        .HasColumnType("int");

                    b.Property<int?>("MessageRegexId")
                        .HasColumnType("int");
                    ...
                    b.Property<int?>("SourceRegexId")
                        .HasColumnType("int");

                    b.Property<DateTime>("UpdatedAt")
                        .HasColumnType("datetime2");

                    b.Property<int?>("UrlRegexId")
                        .HasColumnType("int");

                    b.HasKey("AlertDefinitionId");

                    b.HasIndex("ExceptionTypeRegexId");

                    b.HasIndex("LogLevelExpressionId");

                    b.HasIndex("MessageRegexId");

                    b.HasIndex("RecipientId");

                    b.HasIndex("SourceRegexId");

                    b.HasIndex("UrlRegexId");
            ...
            modelBuilder.Entity("AlertDefinitions.Repositories.Models.AlertDefinition", b =>
                {
                    b.HasOne("AlertDefinitions.Repositories.Models.Regex", "ExceptionType")
                        .WithMany()
                        .HasForeignKey("ExceptionTypeRegexId");

                    b.HasOne("AlertDefinitions.Repositories.Models.LogLevelExpression", "LoglevelExpression")
                        .WithMany()
                        .HasForeignKey("LogLevelExpressionId");

                    b.HasOne("AlertDefinitions.Repositories.Models.Regex", "Message")
                        .WithMany()
                        .HasForeignKey("MessageRegexId");

                    b.HasOne("AlertDefinitions.Repositories.Models.Recipient", "Recipient")
                        .WithMany()
                        .HasForeignKey("RecipientId");

                    b.HasOne("AlertDefinitions.Repositories.Models.Regex", "Source")
                        .WithMany()
                        .HasForeignKey("SourceRegexId");

                    b.HasOne("AlertDefinitions.Repositories.Models.Regex", "Url")
                        .WithMany()
                        .HasForeignKey("UrlRegexId");
